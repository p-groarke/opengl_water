...
const WaveConstants wave_constants[] = WaveConstants[](
	  WaveConstants(1, 0.1, normalize(vec2(1, 0)), 1, 8)
	, WaveConstants(1, 0.4, normalize(vec2(1, 0)), 4, 16)
	, WaveConstants(1, 3.2, normalize(vec2(1, 0)), 32, 16)
	, WaveConstants(1, 0.1, normalize(vec2(1, 0.1)), 2, 4)
	, WaveConstants(1, 0.4, normalize(vec2(1, 0.1)), 8, 8)
	, WaveConstants(1, 3.2, normalize(vec2(1, 0.1)), 64, 8)
	, WaveConstants(1, 0.3, normalize(vec2(1, -0.4)), 3, 5)
	, WaveConstants(1, 0.9, normalize(vec2(1, -0.4)), 12, 10)
	, WaveConstants(1, 0.1, normalize(vec2(1, 0.2)), 1.25, 1.25)
	, WaveConstants(1, 0.4, normalize(vec2(1, 0.2)), 5, 5)
	, WaveConstants(1, 1, normalize(vec2(0, 1)), 64, 8)

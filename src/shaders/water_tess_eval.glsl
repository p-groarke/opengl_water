...
const WaveConstants wave_constants[] = WaveConstants[](
	  WaveConstants(1, 0.1, normalize(vec2(1, 0)), 1, 16)
	, WaveConstants(1, 0.2, normalize(vec2(1, 0)), 2, 16)
	, WaveConstants(1, 0.4, normalize(vec2(1, 0)), 4, 16)
	, WaveConstants(1, 0.8, normalize(vec2(1, 0)), 8, 16)
	, WaveConstants(1, 1.6, normalize(vec2(1, 0)), 16, 16)
	, WaveConstants(1, 3.2, normalize(vec2(1, 0)), 32, 32)
	, WaveConstants(0.9, 0.05, normalize(vec2(1, 1)), 1, 8)
	, WaveConstants(0.9, 0.1, normalize(vec2(1, 1)), 2, 8)
	, WaveConstants(0.9, 0.2, normalize(vec2(1, 1)), 4, 8)
	, WaveConstants(0.9, 0.4, normalize(vec2(1, 1)), 8, 8)
	, WaveConstants(0.9, 0.8, normalize(vec2(1, 1)), 16, 8)
	, WaveConstants(0.9, 1.6, normalize(vec2(1, 1)), 32, 8)
	, WaveConstants(0.9, 3.2, normalize(vec2(1, 1)), 64, 8)
	, WaveConstants(0.8, 0.3, normalize(vec2(1, -0.4)), 3, 10)
	, WaveConstants(0.8, 0.6, normalize(vec2(1, -0.4)), 6, 10)
	, WaveConstants(0.8, 0.9, normalize(vec2(1, -0.4)), 12, 10)
	, WaveConstants(0.8, 1.8, normalize(vec2(1, -0.4)), 24, 10)
	, WaveConstants(0.7, 0.1, normalize(vec2(0, 1)), 1.25, 1.25)
	, WaveConstants(0.7, 0.2, normalize(vec2(0, 1)), 2.5, 5)
	, WaveConstants(0.7, 0.4, normalize(vec2(0, 1)), 5, 5)
	, WaveConstants(0.7, 0.8, normalize(vec2(0, 1)), 10, 5)
